(function () {
  var h = {},
    mt = {},
    c = {
      id: "195b6796d001b750b1bf8e507b220b98",
      dm: ["home.junhu.ren"],
  ...
  mt.cookie.set = function (f, a, b) {
    var e;
    b.D && ((e = new Date()), e.setTime(e.getTime() + b.D));
    document.cookie =
      f +
      "=" +
      a +
  ...
  mt.cookie.get = function (f) {
    return (f = RegExp("(^| )" + f + "=([^;]*)(;|$)").exec(document.cookie))
      ? f[2]
      : u;
  };
  mt.cookie.tb = function (f, a) {
    try {
      ...
      mt.cookie.set(b, "42", { domain: f, path: a, D: r });
      var e = "42" === mt.cookie.get(b) ? "1" : "0";
      mt.cookie.set(b, "", { domain: f, path: a, D: -1 });
      return e;
    } catch (d) {
      return "0";
    }
  ...
  (function () {
    ...
    mt.lang.find = function (a, b, e) {
      if (mt.lang.isArray(a) && mt.lang.k(b))
        for (var d = a.length, g = 0; g < d; g++)
          if (g in a && b.call(e || a, a[g], g)) return a[g];
      return u;
    };
    mt.lang.Y = function (a, b) {
      return (
        mt.lang.find(a, function (e) {
          return e === b;
        }) != u
      );
    };
    ...
    mt.lang.$b = function (a, b) {
      ...
      var d = "00000000000000000000000000000000",
        ...
        k = e(b);
      return parseInt(
        (d + ((g[0] | k[0]) >>> 0).toString(2)).slice(-32) +
          (d + ((g[1] | k[1]) >>> 0).toString(2)).slice(-32),
        2
      );
    };
    mt.lang.extend = function (a) {
      for (
        var b = Array.prototype.slice.call(arguments, 1), e = 0;
        e < b.length;
        e++
      ) {
        var d = b[e],
  ...
  (function () {
    ...
    mt.d.Xb = function (b) {
      ...
      try {
        ...
        for (
          var e = b.split(">"), d = document.body, a = e.length - 1;
          0 <= a;
          a--
        )
          if (-1 < e[a].indexOf("#")) {
            ...
            (d = document.getElementById(k)) ||
              (d = document.getElementById(decodeURIComponent(k)));
        ...
        for (b = 0; d && b < e.length; ) {
          ...
          if (!("html" === l || "body" === l)) {
            ...
            for (n = 0; n < d.childNodes.length; n++)
              1 === d.childNodes[n].nodeType &&
                d.childNodes[n].nodeName.toLowerCase() === l &&
                k.push(d.childNodes[n]);
            if (!k[a]) return u;
            d = k[a];
          }
          b++;
    ...
    mt.d.ha = function (b, e) {
      ...
      for (; b.parentNode != u; ) {
        for (
          var k = 0, l = 0, f = b.parentNode.childNodes.length, n = 0;
          n < f;
          n++
        ) {
          var t = b.parentNode.childNodes[n];
          if (
            t.nodeName === b.nodeName &&
            (k++, t === b && (l = k), 0 < l && 1 < k)
          )
            break;
        }
    ...
    mt.d.Wa = function (b) {
      ...
      return {
        ...
        left:
          e.left + (window.pageXOffset || a.scrollLeft) - (a.clientLeft || 0),
      };
    };
    mt.d.hc = function (b, e) {
      if (b)
        for (var a = b.childNodes, g = 0, k = a.length; g < k; g++) {
          ...
          if (l && 3 === l.nodeType)
            return (
              (a = l.textContent || l.innerText || l.nodeValue || ""),
              l.textContent
                ? (l.textContent = e)
                : l.innerText
                ? (l.innerText = e)
    ...
    mt.d.gc = function (b, a) {
      ...
      for (var g in a)
        a.hasOwnProperty(g) &&
          a[g] !== r &&
          ((d[g] = b.getAttribute(g) || ""), b.setAttribute(g, a[g]));
      return d;
    };
    ...
    mt.d.bb = function (b) {
      var a = "";
      b.textContent
        ? (a = f.trim(b.textContent))
        : b.innerText && (a = f.trim(b.innerText));
      a && (a = a.replace(/\s+/g, " ").substring(0, 255));
      return a;
    };
    mt.d.Wb = function (b, e) {
      var d;
      f.$(b) && 0 === String(b).indexOf("!HMCQ!")
        ? ((d = String(b)),
          (d = a.f(document.location.href, d.substring(6, d.length))))
        : f.$(b) ||
          ((d = mt.d.Sa(b)),
          "input" === d && e && ("button" === b.type || "submit" === b.type)
            ? (d = f.trim(b.value) || "")
            : "input" === d && !e && "password" !== b.type
            ? (d = f.trim(b.value) || "")
            : "img" === d
            ? ((d = mt.d.getAttribute),
    ...
    (function () {
      (mt.d.bc = (function () {
        function a() {
          if (!a.L) {
            a.L = s;
            for (var e = 0, d = g.length; e < d; e++) g[e]();
          }
        }
        function e() {
          try {
        ...
        (function () {
          if (!d)
            if (((d = s), "complete" === document.readyState)) a.L = s;
        ...
        default:
          ...
          if (b instanceof Array) {
            var d = ["["],
              ...
              q;
            for (l = 0; l < g; l++)
              switch (((q = b[l]), typeof q)) {
                case "undefined":
                case "function":
                case "unknown":
                  break;
                default:
                  k && d.push(","), d.push(mt.z.stringify(q)), (k = 1);
              }
            d.push("]");
            return d.join("");
          }
          ...
          for (g in b)
            if (Object.prototype.hasOwnProperty.call(b, g))
              switch (((q = b[g]), typeof q)) {
                case "undefined":
                case "unknown":
                case "function":
                  break;
                default:
                  d && k.push(","), (d = 1), k.push(l(g) + ":" + l(q));
              }
          k.push("}");
          return k.join("");
      }
  ...
  mt.localStorage.set = function (f, a, b) {
    ...
    try {
      window.localStorage
        ? ((a = e.getTime() + "|" + a), window.localStorage.setItem(f, a))
        : mt.localStorage.R() &&
          ((mt.localStorage.h.expires = e.toUTCString()),
  ...
  mt.localStorage.get = function (f) {
    if (window.localStorage) {
      if ((f = window.localStorage.getItem(f))) {
        var a = f.indexOf("|"),
          b = f.substring(0, a) - 0;
        if (b && b > new Date().getTime()) return f.substring(a + 1);
      }
  ...
  (function () {
    ...
    mt.B.ya = function (a) {
      function b(b) {
        var p = a[b];
        if (p)
          if ((t && clearTimeout(t), "success" !== b)) p && p(n);
          else {
            var d;
            try {
      ...
      try {
        ...
        "GET" === g &&
          (e && ((d += (0 <= d.indexOf("?") ? "&" : "?") + e), (e = u)),
          q &&
            (d +=
              (0 <= d.indexOf("?") ? "&" : "?") + "b" + +new Date() + "=1"));
        n.open(g, d, s);
        ...
        for (var p in k) k.hasOwnProperty(p) && n.setRequestHeader(p, k[p]);
        l &&
  ...
  (function () {
    var f = {
      ...
      l: function (a, b) {
        this.w[a] = this.w[a] || [];
        for (var e = this.w[a].length, d = 0; d < e; d++) this.w[a][d](b);
      },
    };
    return (h.t = f);
  })();
  (function () {
    var f = mt.lang,
      ...
      b = {
        ...
        na: function (a, d) {
          return (
            b.oa(h.b && h.b.a && h.b.a.u, a, d) ||
            b.oa(document.location.href, a, d)
          );
        },
        oa: function (b, d, g) {
          if (b === r) return v;
        ...
        I: function (a, d) {
          ...
          if (!f.j(g, "Undefined")) {
            if (f.isArray(g)) {
              for (var k = 0; k < g.length; k++) if (b.na(g[k], d)) return s;
              return v;
            }
            if (f.K(g)) {
              var k = [],
    ...
    var f = mt.url,
      ...
      d = {
        ...
        setData: function (g, f, l) {
          try {
            a.set(g, f, { domain: d.J(), path: d.V(), D: l }),
              l ? b.set(g, f, l) : e.set(g, f);
          } catch (q) {}
        },
        removeData: function (g) {
          try {
            a.set(g, "", { domain: d.J(), path: d.V(), D: -1 }),
              e.remove(g),
              b.remove(g);
          } catch (f) {}
        },
        J: function () {
          for (
            ...
            if (f.sb(a, c.dm[b])) return c.dm[b].replace(/(:\d+)?[/?#].*/, "");
          return a;
        },
        V: function () {
      ...
      e = {
        Ja: function (d, f) {
          return function (k) {
            ...
            if (l) {
              ...
              if (n && n === k) l.removeAttribute(d.Q);
        ...
        sa: function (a, b) {
          for (var e = {}, l = String(b).split(">").length, q = 0; q < l; q++)
            (e[b] = ""), (b = b.substring(0, b.lastIndexOf(">")));
          a && f.K(a) && a.da && a.da(e);
        },
        Bb: function (a, b) {
          return function (e) {
            ...
            a &&
              a.O &&
              (b ? a.O(b) : a.O("#" + encodeURIComponent(this.id), e.type));
          };
        },
      };
    return (h.Ka = e);
  ...
  (function () {
    var f = mt.d,
      ...
      l = {
        ...
        Ea: function () {
          return function (a) {
            if (g.I(c.ctrk, s) && ((a = l.Pa(a)), "" !== a)) {
              var b = (
                d.M +
                "//" +
                d.ba +
                "?" +
                h.b.ra().replace(/ep=[^&]*/, "ep=" + encodeURIComponent(a))
              ).length;
              b + (d.H + "").length > d.ea ||
                (b +
                  encodeURIComponent(k.join("!") + (k.length ? "!" : ""))
                    .length +
                  (d.H + "").length >
                  d.ea && l.N(),
                k.push(a),
        ...
        Pa: function (b) {
          ...
          p.push(b.Ob);
          p.push(b.fb);
          (d = "a" === (d.tagName || "").toLowerCase() ? d : f.Oa(d))
            ? (p.push("a"), p.push(a.g(encodeURIComponent(d.href))))
            : p.push("b");
          return p.join("*");
        },
        Va: function (b, d, g, l) {
          ...
          if (
            d &&
            ((p = d.offsetWidth || d.clientWidth),
            (k = d.offsetHeight || d.clientHeight),
            (x = f.Wa(d)),
            (y = x.left),
            (x = x.top),
            a.k(d.getBBox) &&
              ((k = d.getBBox()), (p = k.width), (k = k.height)),
            "html" === (d.tagName || "").toLowerCase())
          )
            (p = Math.max(p, d.clientWidth)), (k = Math.max(k, d.clientHeight));
          return {
        ...
        N: function () {
          0 !== k.length &&
            ((h.b.a.et = 2), (h.b.a.ep = k.join("!")), h.b.n(), (k = []));
        },
      };
    h.t.c("pv-b", l.va);
    return l;
  ...
  (function () {
    ...
    function a() {
      ...
      if ((!k || !q) && l && n) (w = s), (m = +new Date());
      else if (k && q && (!l || !n)) (w = v), (p += +new Date() - m);
      k = l;
      q = n;
      C = setTimeout(a, 100);
    }
    ...
    function e(b) {
      if (
        ...
        (n = "focus" == b.type || "focusin" == b.type ? s : v), a();
    }
    var d = mt.event,
      g = h.t,
      k = s,
    ...
    (function () {
      ...
      "object" == typeof document.onfocusin
        ? (d.c(document, "focusin", e), d.c(document, "focusout", e))
        : (d.c(window, "focus", e), d.c(window, "blur", e));
    })();
    h.U = {
      Xa: function () {
        return +new Date() - t;
  ...
  (function () {
    var f = mt.lang,
      ...
      d = {
        nb: function (d) {
          if (
            (window._dxt === r || f.j(window._dxt, "Array")) &&
    ...
    var b = mt.url,
      ...
      m = {
              ...
              push: function () {
                for (var a = window._hmt, b = 0; b < arguments.length; b++) {
                  ...
                  e.j(d, "Array") &&
                    ...
                    "_setAccount" === d[0] &&
                      1 < d.length &&
                      /^[0-9a-f]{31,32}$/.test(d[1]) &&
                      ((d = d[1]), (a.id = d), (a.cmd[d] = a.cmd[d] || [])));
                }
              },
            }),
        ...
        La: function () {
          ...
          a.cmd[c.id] = { push: m.aa };
        },
        Ma: function () {
          if (0 < m.G.length)
            for (var a = 0, b = m.G.length; a < b; a++) m.aa(m.G[a]);
          m.G = u;
        },
        aa: function (a) {
          var b = a[0];
          if (m.hasOwnProperty(b) && e.k(m[b])) m[b](a);
        },
        ...
        _setReferrerOverride: function (a) {
          1 < a.length &&
            ...
            e.j(a, "String")
              ? ((h.b.a.su =
                  "/" === a.charAt(0)
                    ? k.protocol + "//" + window.location.host + a
                    : a),
                (m.Z = s))
              : (m.Z = v));
        },
        ...
        _setAutoTracking: function (a) {
          if (1 < a.length && ((a = a[1]), v === a || s === a)) h.b.la = a;
        },
        _trackPageDuration: function (a) {
          1 < a.length
            ? ((a = a[1]),
              2 === String(a).split(",").length &&
                ((h.b.a.et = 3), (h.b.a.ep = a), h.b.n()))
            : l.l("duration-send");
          l.l("duration-done");
        },
        _require: function (a) {
          1 < a.length && ((a = a[1]), k.za.test(b.W(a)) && n(a));
        },
            ...
            if (
              ...
              for (var f = 0, g = a.length; f < g; f++) {
                ...
                if (b.plugins[d] && !b.A[d])
                  (b.A[d] = new b.plugins[d](l)), b.m.shift();
                else break;
              }
          }
        },
    ...
    f.prototype = {
      Fb: function () {
        ...
        if ((f = n.getData("Hm_lvt_" + c.id))) {
          for (b = f.split(","); 2592e3 < m.C - b[0]; ) b.shift();
          e = 4 > b.length ? 2 : 3;
          for (m.C - m.ma > c.vdur && b.push(m.C); 4 < b.length; ) b.shift();
          f = b.join(",");
          b = b[b.length - 1];
        } else (f = m.C), (b = ""), (e = 1);
        this.pb()
          ? (n.setData("Hm_lvt_" + c.id, f, c.age),
      ...
      Ca: function () {
        var a = "Hm_clear_cookie_" + c.id,
          b = t.get(a) || 0;
        c.fc && Number(c.fc) > Number(b) && (this.fa(), t.set(a, c.fc));
      },
      fa: function () {
